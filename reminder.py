            ...
            for i in self.ls:
                ...
                while True:
                    ...
                    if diff.days>0:
                        ...
                        print(f"Time left:\nHours:{diff.seconds//3600}")
                    #print('sleeping......for',diff.days*43200+diff.seconds//3600,'hrs')
                    ...
                    if datetime.now()>=i[0]:
                        ...
                        self.tts.say('Time:'+str(i[0].hour)+':'+str(i[0].minute))
                        self.tts.runAndWait()
                        self.tts.say(i[1])
                        self.tts.runAndWait()
                        ...
                        sleep(5)
                        break
                    self.ls=sorted(self.ls,key=lambda x:x[0]>now)
